...
| Role          | Font        | Size (clamp)            | Weight | Letter-spacing |
|---------------|-------------|-------------------------|--------|----------------|
| Hero H1       | Montserrat  | clamp(2.5rem,8vw,4rem)  | 700    | -0.01em        |
| Section H2    | Montserrat  | clamp(1.8rem,4vw,2.25rem)| 700   | -0.01em        |
| Sub-heading H3| Montserrat  | 1.375rem                | 700    | 0              |
| Body text     | Inter       | 17px                    | 400    | normal         |
| Caption/label | Inter       | 14px                    | 400    | normal         |
| Nav links     | Inter       | 13px                    | 400    | 0.02em         |
...
- Left: band logo/name "Five Dollar Down" in Montserrat 700, var(--c-white).
...
- Column 1:
  - Band name: "Five Dollar Down" in Montserrat 700, var(--c-white)
  - Tagline: "Ottawa's premier party band" — Inter, small, muted white
- Column 2:
...
- Column 3:
  ...
  - Each icon hover state: color transitions to var(--c-accent) cyan with var(--t-fast)
...
- Headings (h1, h2, h3) and band name text use var(--c-white) — NOT var(--c-accent)
- var(--c-accent) cyan is reserved for interactive elements: borders, buttons, links, hover states, labels, badges
